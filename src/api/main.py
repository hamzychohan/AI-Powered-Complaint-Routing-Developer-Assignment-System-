...
async def chat_endpoint(request: ChatRequest):
    try:
        ...
        return ChatResponse(
            ...
            latency_ms=result.get("latency_breakdown", {}).get("total_ms", 0)
        )
...
# Mount knowledge base documents
kb_dir = os.path.join(os.path.dirname(src_dir), "datasets", "knowledge_base")
if os.path.exists(kb_dir):
    app.mount("/kb", StaticFiles(directory=kb_dir), name="knowledge_base")
